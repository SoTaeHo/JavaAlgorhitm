...
/*                                                  +#+      +#+        +#+   */
/*   https://boj.kr/11505                          #+#        #+#      #+#    */
/*   Solved: 2025/05/06 21:21:44 by thxogh1       ###          ###   ##.kr    */
/*                                                                            */
/* ************************************************************************** */
...
public class Main {
    ...
    public static long query(long[] tree, int node, int left, int right, int start, int end) {
        ...
        long lsum = query(tree, node * 2, left, right, start, (start + end) / 2) % 1000000007;
        long rsum = query(tree, node * 2 + 1, left, right, (start + end) / 2 + 1, end) % 1000000007;
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int i = 0; i < M + K; i++) {
            ...
            // a == 2인 경우 부분 곱 구하기
                ...
                System.out.println(query(tree, 1, left - 1, right - 1, 0, N - 1) % 1000000007);
            }
        }
    }
}